...
class LLMClient:
    ...
    def query(self, prompt: str, system_instruction: Optional[str] = None) -> str:
        ...
        api_key = self.settings.gemini_api_key or self.settings.openrouter_api_key or self.settings.deepseek_api_key
        if not api_key:
    ...
    def _call_openrouter(self, prompt: str, system_instruction: Optional[str] = None) -> str:
