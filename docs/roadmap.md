...
- [ ] Refactor and modularize the monolithic `generate_landscape_table.py` script:
  ...
  - Split the main landscape compilation loops and registry processing logic into `src/utils/landscape/compiler.py`, leaving `generate_landscape_table.py` as a lightweight, clean CLI router/entrypoint.
